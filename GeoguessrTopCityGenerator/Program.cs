...
namespace GeoguessrTopCityGenerator
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome! This program will generate a json file for importing into map-making.app that will contain the most populous cities of every geoguessr valid country.\nAfter the process runs and closes, import coordinates.json into map-making.app");
